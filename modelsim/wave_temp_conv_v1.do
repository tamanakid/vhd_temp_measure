...
add wave -noupdate -group SPI_Controller_signals /test_temp_conv/dut_medt/ena_rd
add wave -noupdate -group SPI_Controller_signals /test_temp_conv/dut_medt/read_done
add wave -noupdate -group SPI_Controller_signals /test_temp_conv/dut_medt/timer_ena_nCS
add wave -noupdate -group SPI_Controller_signals /test_temp_conv/dut_medt/spi_SC_down
add wave -noupdate -group SPI_Controller_signals /test_temp_conv/dut_medt/spi_SC_up
add wave -noupdate -group SPI_Controller_signals /test_temp_conv/dut_medt/spi_SI_read
add wave -noupdate -group SPI_Controller_status /test_temp_conv/dut_medt/spi_controller/state
add wave -noupdate -group SPI_Controller_status -radix unsigned /test_temp_conv/dut_medt/spi_controller/read_bit_count
add wave -noupdate -group SPI_Controller_status -radix unsigned /test_temp_conv/dut_medt/spi_controller/read_interval
add wave -noupdate -group SPI_Controller_status -radix unsigned /test_temp_conv/dut_medt/spi_controller/wait_2sec_count
add wave -noupdate -group SPI_Controller_status /test_temp_conv/dut_medt/spi_controller/wait_done
add wave -noupdate -group Timer -radix unsigned /test_temp_conv/dut_medt/timer/timer_2sec
add wave -noupdate -group Timer /test_temp_conv/dut_medt/timer/timer_2sec_eoc
add wave -noupdate -group Timer -radix unsigned /test_temp_conv/dut_medt/timer/timer_2ms5
add wave -noupdate -group Timer /test_temp_conv/dut_medt/timer/timer_2ms5_eoc
add wave -noupdate -group Timer -radix unsigned /test_temp_conv/dut_medt/timer/timer_spi
add wave -noupdate -group Timer /test_temp_conv/dut_medt/timer/timer_spi_eoc
